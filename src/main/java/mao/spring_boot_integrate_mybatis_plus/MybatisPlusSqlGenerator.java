package mao.spring_boot_integrate_mybatis_plus;
 ...
 * Package(包名): mao.spring_boot_integrate_mybatis_plus
 * Class(类名): MybayisPlus
 * Author(作者）: mao
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        */
        ...
        FastAutoGenerator.create(properties.getProperty("jdbc.url"),
                ...
                {
                    builder.parent("mao.spring_boot_integrate_mybatis_plus") // 设置父包名
